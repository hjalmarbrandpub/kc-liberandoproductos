...
PRACTISE_ENDPOINT_REQUESTS = Counter('practise_requests_total', 'Total number of requests to KeepCoding Practise endpoint')
...
class SimpleServer:
    ...
    async def read_main():
        ...
        # Increment counter used for register the total number of calls in the webserver
        REQUESTS.inc()
        # Increment counter used for register the total number of calls in the KeepCoding practise endpoint
        PRACTISE_ENDPOINT_REQUESTS.inc()
        return {"msg": "KeepCoding practise message"}
